...
(async () => {
    ...
    await page.waitForSelector('.wizard-btn[data-teams="32"]');
    await page.click('.wizard-btn[data-teams="32"]');
    
    await page.waitForSelector('.wizard-btn[data-rounds="3"]');
    await page.click('.wizard-btn[data-rounds="3"]');
    
    await page.waitForSelector('#randomFill');
    await page.click('#randomFill');
    
    await page.waitForFunction('!document.querySelector("#startGroups").disabled');
